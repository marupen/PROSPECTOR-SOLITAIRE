...
public class Deck : MonoBehaviour
{
    ...
    public void InitDeck(string deckXMLText)
    {
        ...
        // Инициализировать словарь co спрайтами значков мастей
    ...
    public void ReadDeck(string deckXMLText)
    {
        ...
        for (int i = 0; i < xDecos.Count; i++)
        {
            ...
            // Vector3 loc инициализируется как [0,0,0], остается только изменить его
        ...
        for (int i = 0; i < xCardDefs.Count; i++)
        {
            ...
            // Получить значения атрибута и добавить их в сDef
    ...
    public void MakeCards()
    {
        ...
        // Создать список co всеми картами
        cards = new List<Card>();
