...
// Перечисление co всеми возможными событиями начисления очков
...
public class ScoreManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if(S == null)
        {
            S = this; // Подготовка объекта-одиночки
        }
        else
        {
    ...
    void Event(eScoreEvent evt)
    {
        switch (evt)
        {
            ...
            case eScoreEvent.gameLoss: // Проигрыш в раунде
                ...
                multiplier = 0; // сбросить множитель золотых карт
                break;
            ...
            case eScoreEvent.mine: // Удаление карты из основной раскладки
                ...
                chain++; // увелиичить количество очков в цепочке
                scoreRun += chain * (multiplier + 1); // добавить очки за карту
                break;
        }
